                        ...
                        switch (Ai_BoardArray[x][y].PieceType)
                        {
                            case "Pawn":
                                if (Play_as == "Black")
                                {
                                    if (y + 1 < 8)
                                    {
                                        if (Ai_BoardArray[x][y + 1].HasPiece == false)
                                        {
                                            if (depth > 0)
                                            {
                                                if (checkscore(x, y + 1) >= Score_B)
                                                {
                                            ...
                                            else
                                            {
                                                ...
                                                return checkscore(x, y + 1);
                                            }
                                        }
                                        if (x + 1 < 8)
                                        {
                                            if (Ai_BoardArray[x + 1][y + 1].HasPiece == true)
                                            {
                                                if (depth > 0)
                                                {
                                                    if (checkscore(x + 1, y + 1) >= Score_B)
                                                    {
